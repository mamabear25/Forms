    ...
    return (
        <div className="p-6 max-w-7xl mx-auto bg-formColor rounded-lg ">
            ...
            <div className="space-y-4 border-l border-r border-gray-200">
                <div className="flex items-center bg-white p-4 border border-gray-300">
                    <input
                        type="radio"
                        id="sameAddress"
                        name="addressType"
                    ...
                    />
                    <label htmlFor="sameAddress" className="ml-3 block font-medium text-gray-700">
                        No, it is the same
                    </label>
                </div>
                ...
                <div className="flex items-center p-4">
                    <input
                        ...
                        className="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                    />
                    <label htmlFor="differentAddress" className="ml-3 block font-medium text-gray-700">
                        Yes, it is different
                    </label>
                </div>
            </div>
            ...
            {isSameAddress === 'no' && (
                <div className="p-6 max-w-7xl mx-auto">
                    ...
                    <div className="mb-4 flex md:whitespace-nowrap">
                        <label htmlFor="add1" className="block  font-medium text-gray-700">
                            Address Line 1
                        </label>
                        <input
                            id="add1"
                            name="add1"
                            type="text"
                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm: w-md"
                        />
                    </div>
                    <div className="mb-4 flex md:whitespace-nowrap">
                        <label htmlFor="add2" className="block  font-medium text-gray-700">
                            Address Line 2
                        </label>
                        <input
                            id="add2"
                    ...
                    <div className="mb-4 flex md:whitespace-nowrap">
                        <label htmlFor="add3" className="block  font-medium text-gray-700">
                            Address Line 3
                        </label>
                        <input
                            id="add3"
                    ...
                    <div className="mb-4 flex md:whitespace-nowrap">
                        <label htmlFor="add4" className="block  font-medium text-gray-700">
                            Address Line 4
                        </label>
                        <input
                            id="add4"
